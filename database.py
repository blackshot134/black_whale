...
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./blackwhale.db")
...
def init_db():
    ...
    services = ["Bomber API", "Sheypoor Scraper", "Divar Scraper", "Search Database", "Email Service", "Location Service"]
